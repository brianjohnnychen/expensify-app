...
const getVisibleExpenses = (expenses, {text, sortBy, startDate, endDate}) => {
    return expenses.filter((expense) => {
        ...
        // Return true if all 3 match, else remove item from visible.
...
store.dispatch(sortByAmount(expenseOne, expenseTwo))
store.dispatch(sortByDate(expenseOne, expenseTwo))
